 ...
 */
function cacheFileFor(target: string): string {
 ...
 */
export async function loadNotesCache(target: string): Promise<NotesCache> {
  try {
 ...
 */
export async function saveNotesCache(target: string, cache: NotesCache): Promise<void> {
  try {
