...
export const DEFAULT_THEME: ThemeId = "tape";
...
export function themeOf(config: { theme?: unknown } | null | undefined): ThemeId {
  return isThemeId(config?.theme) ? config.theme : DEFAULT_THEME;
}
